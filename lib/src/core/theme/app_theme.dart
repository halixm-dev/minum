  ...
  static ThemeData buildThemeDataFromScheme(ColorScheme colorScheme, Brightness brightness) {
    ...
    return ThemeData(
      ...
      textTheme: GoogleFonts.robotoTextTheme(baseTextTheme.copyWith(
        displayLarge: TextStyle(fontSize: 57.sp, fontWeight: FontWeight.w400, color: colorScheme.onBackground),
        displayMedium: TextStyle(fontSize: 45.sp, fontWeight: FontWeight.w400, color: colorScheme.onBackground),
        displaySmall: TextStyle(fontSize: 36.sp, fontWeight: FontWeight.w400, color: colorScheme.onBackground),
        headlineLarge: TextStyle(fontSize: 32.sp, fontWeight: FontWeight.w400, color: colorScheme.onBackground),
        headlineMedium: TextStyle(fontSize: 28.sp, fontWeight: FontWeight.w400, color: colorScheme.onBackground), // Often onSurface for emphasis
        headlineSmall: TextStyle(fontSize: 24.sp, fontWeight: FontWeight.w400, color: colorScheme.onBackground),  // Often onSurface for emphasis
        ...
        bodyLarge: TextStyle(fontSize: 16.sp, fontWeight: FontWeight.w400, color: colorScheme.onBackground),
        ...
        labelMedium: TextStyle(fontSize: 12.sp, fontWeight: FontWeight.w500, color: colorScheme.onBackground), // Or onSurface
        labelSmall: TextStyle(fontSize: 11.sp, fontWeight: FontWeight.w500, color: colorScheme.onBackground), // Or onSurface
      )),
