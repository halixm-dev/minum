...
class AppTheme {
  ...
  static final ThemeData lightTheme = buildThemeDataFromScheme(
    ColorScheme.light(
      ...
      surface: AppColors.lightScaffoldBackground, // Typically the main background
      ...
      scrim: Colors.black.withAlpha(82), // Replaced withOpacity(0.32)
  ...
  static final ThemeData darkTheme = buildThemeDataFromScheme(
    ColorScheme.dark(
      ...
      primaryContainer: AppColors.primaryContainerDark, // M3 Primary Container
      onPrimaryContainer: AppColors.onPrimaryContainerDark, // M3 On Primary Container
      secondary: AppColors.secondaryDark, // M3 Secondary
      onSecondary: AppColors.onSecondaryDark, // M3 On Secondary
      secondaryContainer: AppColors.secondaryContainerDark, // M3 Secondary Container
      ...
      onError: AppColors.onErrorDarkM3, // Using M3 standard dark onError color
      errorContainer: AppColors.errorContainerDark, // This is already M3 compliant
      onErrorContainer: AppColors.onErrorContainerDark, // This is already M3 compliant
      surface: AppColors.darkScaffoldBackground, // Typically the main background
      onSurface: AppColors.darkText,
      surfaceDim: AppColors.surfaceDimDark,
      surfaceBright: AppColors.surfaceBrightDark,
      surfaceContainerLowest: AppColors.surfaceContainerLowestDark, // Existing darkScaffoldBackground
      ...
      inverseSurface: AppColors.lightScaffoldBackground, // M3 Inverse Surface (using light theme's scaffold)
      ...
      scrim: Colors.black.withAlpha(102), // Replaced withOpacity(0.4)
  ...
  static ThemeData buildThemeDataFromScheme(ColorScheme colorScheme, Brightness brightness) {
    ...
    final m3BaseTextTheme = GoogleFonts.robotoTextTheme(baseTextTheme); // Using Roboto as specified
    ...
    return ThemeData(
      ...
      appBarTheme: AppBarTheme(
        elevation: 0, // M3 default elevation is 0, relies on surfaceTint for scroll edge
        backgroundColor: colorScheme.surface, // M3 default is surface
        surfaceTintColor: colorScheme.surfaceTint,
        iconTheme: IconThemeData(color: colorScheme.onSurfaceVariant), // Icons on app bar
        titleTextStyle: m3BaseTextTheme.titleLarge?.copyWith(color: colorScheme.onSurface), // M3 titleLarge, color onSurface
      ),
      textTheme: m3BaseTextTheme.copyWith(
        ...
        displayLarge: m3BaseTextTheme.displayLarge?.copyWith(fontSize: 57.sp, fontWeight: FontWeight.w400, color: colorScheme.onSurface),
        displayMedium: m3BaseTextTheme.displayMedium?.copyWith(fontSize: 45.sp, fontWeight: FontWeight.w400, color: colorScheme.onSurface),
        displaySmall: m3BaseTextTheme.displaySmall?.copyWith(fontSize: 36.sp, fontWeight: FontWeight.w400, color: colorScheme.onSurface),
        headlineLarge: m3BaseTextTheme.headlineLarge?.copyWith(fontSize: 32.sp, fontWeight: FontWeight.w400, color: colorScheme.onSurface),
        headlineMedium: m3BaseTextTheme.headlineMedium?.copyWith(fontSize: 28.sp, fontWeight: FontWeight.w400, color: colorScheme.onSurface),
        headlineSmall: m3BaseTextTheme.headlineSmall?.copyWith(fontSize: 24.sp, fontWeight: FontWeight.w400, color: colorScheme.onSurface),
        titleLarge: m3BaseTextTheme.titleLarge?.copyWith(fontSize: 22.sp, fontWeight: FontWeight.w400, color: colorScheme.onSurface), // Often used for AppBars
        titleMedium: m3BaseTextTheme.titleMedium?.copyWith(fontSize: 16.sp, fontWeight: FontWeight.w500, color: colorScheme.onSurface, letterSpacing: 0.15.sp),
        titleSmall: m3BaseTextTheme.titleSmall?.copyWith(fontSize: 14.sp, fontWeight: FontWeight.w500, color: colorScheme.onSurface, letterSpacing: 0.1.sp),
        bodyLarge: m3BaseTextTheme.bodyLarge?.copyWith(fontSize: 16.sp, fontWeight: FontWeight.w400, color: colorScheme.onSurface, letterSpacing: 0.5.sp),
        bodyMedium: m3BaseTextTheme.bodyMedium?.copyWith(fontSize: 14.sp, fontWeight: FontWeight.w400, color: colorScheme.onSurfaceVariant, letterSpacing: 0.25.sp), // M3 bodyMedium is often onSurfaceVariant
        bodySmall: m3BaseTextTheme.bodySmall?.copyWith(fontSize: 12.sp, fontWeight: FontWeight.w400, color: colorScheme.onSurfaceVariant, letterSpacing: 0.4.sp), // M3 bodySmall is often onSurfaceVariant
        labelLarge: m3BaseTextTheme.labelLarge?.copyWith(fontSize: 14.sp, fontWeight: FontWeight.w500, color: colorScheme.onPrimary, letterSpacing: 0.1.sp), // Used in ElevatedButtons
        labelMedium: m3BaseTextTheme.labelMedium?.copyWith(fontSize: 12.sp, fontWeight: FontWeight.w500, color: colorScheme.onSurfaceVariant, letterSpacing: 0.5.sp),
        labelSmall: m3BaseTextTheme.labelSmall?.copyWith(fontSize: 11.sp, fontWeight: FontWeight.w500, color: colorScheme.onSurfaceVariant, letterSpacing: 0.5.sp),
      ),
      // --- Button Themes ---
      elevatedButtonTheme: ElevatedButtonThemeData( // M3 ElevatedButton: surface background, primary text
        style: ElevatedButton.styleFrom(
          ...
          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20.r)), // M3 "Full" or large radius
        ),
      ),
      filledButtonTheme: FilledButtonThemeData( // M3 FilledButton: primary background, onPrimary text
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        fillColor: colorScheme.surfaceContainerHighest, // M3 Filled TextField fill color
        contentPadding: EdgeInsets.symmetric(horizontal: 16.w, vertical: 12.h), // Padding inside the TextField
        border: OutlineInputBorder( // Default border (usually not visible for enabled state)
          borderRadius: BorderRadius.all(Radius.circular(4.r)), // M3 "ExtraSmall" radius
          borderSide: BorderSide.none, // No border for enabled filled text fields
        ),
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.all(Radius.circular(4.r)),
          borderSide: BorderSide(color: colorScheme.primary, width: 2.0), // Primary color, 2px width
        ),
        errorBorder: OutlineInputBorder(
          borderRadius: BorderRadius.all(Radius.circular(4.r)),
          borderSide: BorderSide(color: colorScheme.error, width: 2.0), // Error color, 2px width
        ),
        focusedErrorBorder: OutlineInputBorder(
          borderRadius: BorderRadius.all(Radius.circular(4.r)),
          borderSide: BorderSide(color: colorScheme.error, width: 2.0),
        ),
        disabledBorder: OutlineInputBorder( // Filled text field has different look when disabled
            borderRadius: BorderRadius.all(Radius.circular(4.r)),
            borderSide: BorderSide.none,
        ),
        labelStyle: m3BaseTextTheme.bodyLarge?.copyWith(color: colorScheme.onSurfaceVariant),
        hintStyle: m3BaseTextTheme.bodyLarge?.copyWith(color: colorScheme.onSurfaceVariant),
        errorStyle: m3BaseTextTheme.bodySmall?.copyWith(color: colorScheme.error), // M3 error text style
      ),

      // --- CardTheme ---
      cardTheme: CardTheme( // Defaulting to M3 Filled Card style
        ...
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(12.r))), // M3 "Medium" radius
      ),
      ...
      iconTheme: IconThemeData(color: colorScheme.onSurfaceVariant), // Default icon color
      ...
      dialogTheme: DialogTheme(
        ...
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(28.r)), // M3 "ExtraLarge" shape
        titleTextStyle: m3BaseTextTheme.headlineSmall?.copyWith(color: colorScheme.onSurface),
        contentTextStyle: m3BaseTextTheme.bodyMedium?.copyWith(color: colorScheme.onSurfaceVariant),
      ),
      ...
      bottomSheetTheme: BottomSheetThemeData(
        ...
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.vertical(top: Radius.circular(28.r)) // M3 "ExtraLarge" top corners
        ),
      ...
      chipTheme: ChipThemeData(
        ...
        labelStyle: m3BaseTextTheme.labelLarge!.copyWith(color: colorScheme.onSurface), // M3 uses onSurface for outlined assist
        side: BorderSide(color: colorScheme.outline), // M3 Outlined Assist chip
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8.r)), // M3 "Small" shape
        padding: EdgeInsets.symmetric(horizontal: 12.w),
        iconTheme: IconThemeData(color: colorScheme.primary, size: 18.sp), // Leading icon for assist chip
