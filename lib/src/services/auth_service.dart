...
class AuthService {
  ...
  Future<UserModel> signInWithEmailAndPassword(
    ...
    try {
      ...
      logger.e(
          "AuthService: AuthException during email sign in - ${e.message}");
      rethrow;
    } catch (e) {
  ...
  Future<UserModel> signUpWithEmailAndPassword(String email, String password,
    ...
    try {
      ...
      logger.e(
          "AuthService: AuthException during email sign up - ${e.message}");
      rethrow;
    } catch (e) {
  ...
  Future<void> sendPasswordResetEmail(String email) async {
    try {
      ...
      logger.e(
          "AuthService: AuthException during password reset - ${e.message}");
      rethrow;
    } catch (e) {
